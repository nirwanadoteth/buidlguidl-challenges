...
const deployedContracts = {
  11155111: {
    DEX: {
      address: "0x9392f9D5a537D32f7630821EdaE32428b87bb13C",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9049152,
    },
    MyUSD: {
      address: "0xaA15573F531221Ba4120cbcB2Eb64e47a69Cb474",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9049151,
    },
    MyUSDEngine: {
      address: "0x09C645618e84387186efBf9687fA602E4D21120B",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9049159,
    },
    MyUSDStaking: {
      address: "0x829CCbA38d4d01CfBB7A3cb696771F31c39eB3D2",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9049158,
    },
    Oracle: {
      address: "0x6a4B8a13ecAb3e12eA167D0c6A718d2AF0163268",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9049157,
    },
    RateController: {
      address: "0x0C0A3FaaabF905F9Caa3aBfde96207cf5B46504b",
      abi: [
        {
          inputs: [
            {
