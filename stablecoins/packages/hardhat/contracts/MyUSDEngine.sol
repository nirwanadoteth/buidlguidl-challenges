...
contract MyUSDEngine is Ownable {
    ...
    function _getCurrentExchangeRate() internal view returns (uint256) {
        ...
        if (interest == 0) return debtExchangeRate;
    ...
    function getCurrentDebtValue(address user) public view returns (uint256) {
        ...
        uint256 currentExchangeRate = _getCurrentExchangeRate();
        return (shares * currentExchangeRate) / PRECISION;
    }
    ...
    function withdrawCollateral(uint256 amount) external {
        ...
        // Reduce collateral and validate safety if needed
    ...
    function liquidate(address user) external {
        ...
        // Liquidator must have sufficient MyUSD and allowance
        ...
        // Burn liquidator's MyUSD to repay user's debt
        ...
        // Determine collateral to seize plus reward
        ...
        // Reduce user's collateral and transfer to liquidator
