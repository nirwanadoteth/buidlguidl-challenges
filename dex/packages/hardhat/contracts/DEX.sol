...
contract DEX {
    ...
    function withdraw(uint256 amount) public returns (uint256 ethAmount, uint256 tokenAmount) {
        ...
        uint256 tokenAmountOut = (amount * tokenReserve) / totalLiquidity;
        ...
        emit LiquidityRemoved(msg.sender, amount, tokenAmountOut, ethWithdrawn);
        return (ethWithdrawn, tokenAmountOut);
    }
}
